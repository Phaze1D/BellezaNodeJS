		...
		<main>
			...
			<div className="grid center">
				<div className="col-11">
					...
					<ul>
						<li>Crema Nutriente de Incienso</li>
						<li>Suero de rejuvenecimiento facial de incienso </li>
						<li>Crema para el Cuerpo de Rosas</li>
						<li>Mascarilla facial enriquecedora de te blanco</li>
					</ul>
				</div>
          ...
          El premio al mejor logro en Productos naturales<br />
          Ganador: Peter Kindersley, fundador de Sheepdrove orgánicos y propietario de<br />
          Neal´s Yard Remedies<br />
          El Premio en categoría de logro sobresaliente Productos Naturales fue aceptado por el hijo de Peter Kindersley, Bernabé, quien dijo:. "Mi padre está encantado y honrado de recibir este premio, sobretodo porque ustedes, la industria natural y orgánica, lo han escogido. El no ha podido estar esta noche con ustedes debido a que esta embotellando aceite de oliva orgánico su ocupación en el aceite de oliva orgánico en España para nuestras tiendas Sheepdrove en Londres y Bristol. <br />
          ...
          Neal´s Yard Remedies fue el ganador en esta categoría<br />
          Ganador</p>
          ...
          Neal´s Yard Remedies fue el ganador esta categoria:<br />
          Ganador<br />
          ...
          Best Organic Product <br />
          Mejor Producto Orgánico<br />
          Ganador<br />
          Humectante Nutriente de uso diario para el cuidado de la piel a base de flor de naranja</p>
				</div>
			</div>
          ...
          Neal´s Yard Remedies fue el ganador en esta categoria:</p>

					<p>Ganador<br />
          Mejor Producto de protección solar<br />
          Fórmula Orgánica para labios de Protección Solar SPF 15 </p>
				</div>
			</div>
          ...
          Crema Hidratante de Incienso</p>
			...
			<div className="grid center">
				<div className="col-11">
					...
					<p>
						Premios de Belleza Revista de Salud Natural 2010 <br />
						Neal´s Yard Remedies fue el ganador en esta categoría y recibiendo mención especial en tres:<br />
						Ganador<br />
						Ganador del premio: La mejor linea de productos orgánicos<br />
						Mención Especial<br />
						Mejor Crema Hidratante para piel grasa: Crema Humectante y Purificante de uso Diario a base de Palmarosa<br />
						Mejor Máscara facial Hidratante: Máscara facial a base de frutos del bosque<br />
						Mejor exfoliante para el cuerpo: Exfoliante para el Cuerpo de naranja y geranio
					</p>
          ...
          Neal´s Yard Remedies fue el ganador en 16 categorías:<br />
          Ganador: Espray Refrescante de Aloe Vera<br />
          Ganador: Baño espumante de Algas y Árnica <br />
          Ganador: Bálsamo de belleza de Rosas Silvestres<br />
          Ganador: Hidratante Rosas y Malva<br />
          Ganador: Crema Hidratante de Incienso<br />
          Ganador: Crema Nutriente para Noche de Flor de Naranja<br />
          Ganador: Aceite Facial de Flor de naranja <br />
          Ganador: Máscara Facial Antioxidante de rosas Organica<br />
          Ganador: Crema Nutriente de Incienso<br />
          Ganador: Fórmula de labios Orgánica<br />
          Ganador: Acondicionador Nutriente de Rosas<br />
          Ganador: Gel para baño de naranja y geranio<br />
          Ganador: Loción para manos de menta y bergamota <br />
          Ganador: Crema de rosas para el Cuerpo<br />
          ...
          Neal´s Yard Remedies fue el ganador en 4 categorías:<br />
          Ganador: Agua de rosas<br />
          Ganador: Crema Nutriente de Incienso<br />
          ...
          Neal´s Yard Remedies fue el ganador en 3 categorías:<br />
          Ganador:<br />
          Limpiador Facial Rejuvenecimiento de Incienso <br />
          Bronce:<br />
          Mascara Facial Nutriente de Flor de naranja <br />
          Mención Especial:<br />
			...
			<div className="grid center">
				<div className="col-11">
					...
					<p>Ganador del premio a la mejor línea de productos orgánicos Neal´s Yard Remedies<br />
						<br />
          Ganador Mejor Crema para noche:<br />
          Crema de almendras y rosas para noche<br />
          Mejor Mascarilla para limpieza facial Ganador:<br />
          Bálsamo de rosas<br />
						<strong>Mención Especial </strong><br />
